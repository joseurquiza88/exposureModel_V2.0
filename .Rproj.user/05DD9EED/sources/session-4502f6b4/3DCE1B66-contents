...
map_colors <- function(grid,pollutant){ #PM2.5 (μg/m3) 24-hour
  if (pollutant == "PM2.5"){
    ...
    print(c("The entered pollutant is: ",pollutant))
    grid$categories = case_when(grid$value<=54 ~ 'Good',
    ...
    print(c("The entered pollutant is: ",pollutant))
    grid$categories = case_when(grid$value<= 4.4 ~ 'Good',
    ...
    print(c("The entered pollutant is: ",pollutant))
    grid$categories = case_when(grid$value<= 35 ~ 'Good',
    ...
    print(c("The entered pollutant is: ",pollutant))
    grid$categories = case_when(grid$value<= 53 ~ 'Good',
  ...
  else if (pollutant == "O3" ||pollutant == "o3"){ #O3 (ppm) 1-hour1
    print(c("The entered pollutant is: ",pollutant))
  grid$categories = case_when(
